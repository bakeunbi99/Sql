...
#직원 테이블 데이터 입력하기
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a101', '박혁거세', '010-1234-1001', '부장', '101', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a102', '김유신', '010-1234-1002', '차장', '101', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a103', '김춘추', '010-1234-1003', '사원', '101', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a104', '장보고', '010-1234-1004', '대리', '102', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a105', '강감찬', '010-1234-1005', '과장', '102', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a106', '이성계', '010-1234-1006', '차장', '103', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a107', '정철', '010-1234-1007', '차장', '103', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a108', '이순신', '010-1234-1008', '부장', '104', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a109', '허균', '010-1234-1009', '부장', '104', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a110', '정약용', '010-1234-1010', '사원', '105', NOW());
INSERT INTO `MEMBER`(`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES('a111', '박지원', '010-1234-1011', '사원', '105', NOW());

#부서 테이블 데이터 입력하기
INSERT INTO `DEPART` VALUES('101', '영업1부', '051-552-1001');
INSERT INTO `DEPART` VALUES('102', '영업2부', '051-552-1002');
INSERT INTO `DEPART` VALUES('103', '영업3부', '051-552-1003');
INSERT INTO `DEPART` VALUES('104', '영업4부', '051-552-1004');
INSERT INTO `DEPART` VALUES('105', '영업5부', '051-552-1005');
INSERT INTO `DEPART` VALUES('106', '영업지원부', '051-552-1006');
INSERT INTO `DEPART` VALUES('107', '인사부', '051-552-1007');
...
SELECT * FROM `MEMBER` WHERE `name` <> '김춘추';
SELECT * FROM `MEMBER` WHERE `pos` = '사원' AND `pos` = '대리';
...
INSERT INTO `MEMBER` VALUES('b101', '을지문덕', '010-5555-1234', 107, NOW());
...
#확인 문제3
SELECT min(sales), MAX(sales), sum(sales) FROM `SALE`
WHERE `year` = '2020';
...
SELECT SALE.seq, SALE.year, SALE.month, SALE.uid, SALE.name, pos, sales
FROM `SALE`
...
SELECT a.seq, a.uid, a.sales, b.name, b.pos, a.year, SUM(`sales`) AS `합계`
FROM `SALE` AS a
JOIN `MEMBER` AS b
ON a.uid = b.uid
...
#실습하기 4-10
SELECT * FROM `SALE`
LEFT JOIN `MEMBER` ON `SALE`.uid = `MEMBER`.uid;


#확인문제1 : 모든 직원의 아이디, 이름, 직급, 부서명을 검색하시오
SELECT * FROM `MEMBER`;
SELECT * FROM `DEPART`;
...
SELECT SUM(`sales`) AS '2019년 매출 합'
FROM `MEMBER` AS a
JOIN `SALE` AS b
ON a.uid = b.uid
...
SELECT a.uid, b.name, a.year, sum(a.sales) AS `합계`
FROM `SALE` AS a
JOIN `MEMBER` AS b
JOIN `DEPART` AS c
USING(`uid`)
